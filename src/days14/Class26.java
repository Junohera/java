...
class StaticC {
	...
	public static int getCount() { return count; } // 스태틱 메서드에는 호출 객체가 없으므로 this도 존재하지 않습니다.
	
	// 아래와 같이 static으로 선언되지 않은 인스턴스 메서드는 클래스이름을 붙여서도 사용할 수 있습니다.
...
public class Class26 {
	public static void main(String[] args) {
		 ...
		 * public 접근지정자를 사용하는 static메소드로 private으로 지정된 static 멤버의 값을 참조합니다.
		 */
