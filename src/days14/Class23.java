...
public class Class23 {
	public static void main(String[] args) {
		 ...
		 * Math 클래스 안에 public static int abs(int n) { }와 같은 양식의 sqrt, random 메서드가 있습니다.
		 ...
		 * Random 클래스의 nextInt() 메서드는 동적멤버메서드이므로 객체 생성 후 호출객체를 앞에 두고 사용합니다.
		...
		// Integer 클래스의 parseInt메소드는 문자열로 되어있는 정수값을 int타입으로 변환
		String strNum1 = "100";
		String strNum2 = "50";
		// 문자열 결합
		...
		// Double 클래스의 parseDouble 메서드는 문자열로 되어있는 실수값을 double타입으로 반환
		strNum1 = "10.75";
		strNum2 = "5.2";
		// 문자열 결합
		...
		// 참고로 정수나 실수를 문자로 바꾸는 스태틱메서드는 String 클래스내에 있습니다.
