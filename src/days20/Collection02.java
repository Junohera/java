...
/*
 * 컬렉션 클래스 저장 방식
 * 모든 컬렉션 클래스들은 기본적으로 Object타입을 저장/반환할 수 있습니다.
 * 
 * Object타입을 매개변수로 사용하는 모든 컬렉션클래스들은 타입에 상관없이 저장할 수 있음
...
public class Collection02 {
	public static void main(String[] args) {
		 ...
		 * 다만 자료형을 섞어서 저장하고 사용할 경우 위의 에러 내역과 같이 꺼내고, 형변환때 자료형이
		 * 맞지 않아 에러가 발생할 확률이 높아집니다.
		 * 
