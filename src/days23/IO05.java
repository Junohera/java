...
/*
 * #decorator #decoration #pattern #design #architecture
 */
public class IO05 {
	public static void main(String[] args) throws IOException {
		 ...
		 * 버퍼 : 프로그램의 입출력 성능을 향상시키기 위해서 사용되는 중간저장 메모리
		...
		String message = br.readLine(); // 최초로 입력 변수에 String사용됨
		System.out.printf("입력된 메시지는 %d 글자입니다.\n", message.length());
		System.out.println(message);
		/*
		 * 스트림은 메모리 누수현상을 방지하기 위해서 반드시 close 메서드를 호출하여 종료를 해야함.
